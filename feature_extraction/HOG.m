...
function H = HOG(Im, hog_param)
nwin_x = hog_param.nwin_x;  %set here the number of HOG windows per bound box
nwin_y = hog_param.nwin_y;
B = hog_param.num_bins;	%set here the number of histogram bins
